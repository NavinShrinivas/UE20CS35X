...
{
       0,    30,    30,    33,    34,    35,    36,    39,    43,    44,
      47,    57,    72,    73,    74,    75,    79,    96,    97,   100,
     105,   110,   114,   119,   124,   127,   128,   145,   153,   163,
     164,   165,   166,   167,   168,   173,   175,   176,   179,   180,
     181,   185,   186,   189,   191,   192,   195,   196,   197,   198
};
#endif
...
static const char *const yytname[] =
{
  ...
  "REL_OP", "MAIN", "EMPTY_LISTVAR", "STMT", "STMT_NO_BLOCK", "BLOCK",
  "COND", YY_NULLPTR
};
...
{
      32,   -27,   -27,   -27,   -27,     2,     9,   -27,    15,   -22,
      16,    32,    42,   -27,    32,    -5,    27,    30,   -27,    32,
     -27,   -27,   -27,   -27,    42,    17,   -21,   -19,   -27,   -27,
      19,    42,    19,   -27,    10,   -27,   -27,   -27,   -27,   -27,
     -27,    42,    42,    42,    42,    42,    30,    24,    17,   -27,
     -27,   -21,   -19,   -19,   -27,   -27,    28,    -1,    38,    -1,
      46,    19,    47,    36,    -1,    -1,    45,    39,   -27,   -27,
     -27,   -27,   -27,     2,   -27,    17,    48,   -27,    -1,    58,
      -1,   -27
};
...
static const yytype_int8 yydefact[] =
{
      ...
      25,    17,    19,    20,    22,    23,     0,    40,     0,    40,
       0,     0,     0,     0,    40,    40,     0,     0,    41,    42,
      35,    38,    39,    26,    45,    44,     0,    43,    40,    48,
      40,    49
};
...
{
     -27,   -27,    -4,    44,    54,    51,    53,     0,   -23,    49,
     -17,    -3,   -27,   -27,   -27,   -26,   -27,   -27,   -27
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     6,     7,    60,    17,    18,    61,    62,    25,    26,
      27,    28,    41,    11,    47,    63,    64,    65,    76
};
...
static const yytype_int8 yytable[] =
{
      ...
      58,    35,    36,    37,    38,    52,    53,     5,    35,    36,
      37,    38,    30,    67,    12,     1,     2,     3,    71,    72,
      59,    54,    55,    75,     8,    14,    19,    16,    50,    39,
      40,     4,    79,     9,    81,     8,    39,    40,     8,    31,
       5,    32,    56,     8,     9,    21,    74,     9,    21,    57,
      22,    23,     9,    73,    23,    66,    68,    69,    70,    24,
      80,    77,    24,    49,    46,     0,    78,     0,     0,     0,
      51
};
...
static const yytype_int8 yycheck[] =
{
      ...
      13,    14,    37,    59,    32,     3,     4,     5,    64,    65,
      41,    44,    45,    66,     0,    30,    30,    28,    38,    39,
      40,    19,    78,     0,    80,    11,    39,    40,    14,    32,
      28,    31,    38,    19,    11,    23,    66,    14,    23,    41,
      28,    29,    19,    28,    29,    37,    30,    30,    42,    37,
      22,    42,    37,    32,    30,    -1,    38,    -1,    -1,    -1,
      41
};
...
static const yytype_int8 yystos[] =
{
      ...
      40,    56,    33,    34,    35,    36,    48,    58,    52,    49,
      38,    53,    54,    54,    55,    55,    38,    41,    21,    41,
      47,    50,    51,    59,    60,    61,    37,    59,    30,    30,
      42,    59,    59,    28,    51,    52,    62,    42,    38,    59,
      22,    59
};
...
#line 47 "parser.y"
           ...
           int temptype = type_check(yyvsp[0]);
           int longtype = retrieve_type(yyvsp[-2]);
...
#line 57 "parser.y"
				...
				/*
                    		...
                    		*/
               if(check_sym_tab(yyvsp[0]) == 1){
                yyerror("Re-declared variable!");
               }else{
                  insert_symbol(yyvsp[0],size,type,yylineno,scope);
               }
			}
#line 1327 "y.tab.c"
    break;
...
#line 100 "parser.y"
                { 
         if(type_check(yyvsp[-2]) == 1 || type_check(yyvsp[0]) == 1){
...
#line 128 "parser.y"
                {
            if(check_sym_tab(yyvsp[0])==0){
               yyerror("variable not decalred");
            }
            if(retrieve_val(yyvsp[0])==NULL){
