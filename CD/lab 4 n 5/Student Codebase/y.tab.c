...
#line 41 "parser.y"
              ...
              expression_node* node = init_exp_node("+",(yyvsp[-2].exp_node),(yyvsp[0].exp_node));
              (yyval.exp_node) = node;
				}
#line 1163 "y.tab.c"
    break;
...
#line 72 "parser.y"
              ...
              expression_node* node = init_exp_node((yyvsp[0].text),NULL,NULL);
              (yyval.exp_node) = node;
			}
#line 1224 "y.tab.c"
    break;
